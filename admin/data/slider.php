  ...
  <div data-scroll-to-active="true" class="main-menu menu-fixed menu-dark menu-accordion menu-shadow">
    ...
    <div class="main-menu-content">
      <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
        ...
        <li class=" nav-item"><a href="form-layout-basic.html"><i class="icon-image3"></i><span data-i18n="nav.form_layouts.form_layout_basic" class="menu-title">Slider</span></a>
        </li>
        <li class=" nav-item"><a href="form-layout-basic.html"><i class="icon-paper"></i><span data-i18n="nav.form_layouts.form_layout_basic" class="menu-title">Berita</span></a>
        </li>
        <li class=" nav-item"><a href="form-layout-basic.html"><i class="icon-user4"></i><span data-i18n="nav.form_layouts.form_layout_basic" class="menu-title">Akun</span></a>
        </li>
        <li class=" nav-item"><a href="form-layout-basic.html"><i class="icon-mail6"></i><span data-i18n="nav.form_layouts.form_layout_basic" class="menu-title">Pesan</span></a>
        </li>                                     
      </ul>
    </div>
    <!-- /main menu content-->
        ...
        <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-xs-12">
          <div class="breadcrumb-wrapper col-xs-12">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active"><a href="#">Tambah Slider</a>
              </li>
            </ol>
          </div>
        </div>
             ...
             <form class="form">
               <div class="form-body">       
                <div class="form-group">
                 ...
                 <input type="text" id="judul" class="form-control" placeholder="Judul Slider" name="judul">
               </div>
