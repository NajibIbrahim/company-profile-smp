...
<head>
  <meta charset="utf-8">
  <title>Profil | SMP Tahfidz Al Hikmah Semarang</title>
              ...
              <div class="slider-content text-center">
                <div class="header-bottom">
                  <div class="layer2 wow zoomIn" data-wow-duration="1s" data-wow-delay=".4s">
                    <h1 class="title2">Informasi Pendaftaran</h1>
                  </div>
                ...
                <div class="row">
                  <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="single-blog">
                     ...
                     <div class="blog-text">
                      <h4>
                        Informasi Seputar Pendaftaran Siswa Baru
                      </h4>
                      <p style="text-align: justify;">
                        <b>SMP Tahfidz Al Hikmah Semarang</b> menerima pendaftaran peserta didik baru tahun ajaran 2019/2020 dengan persyaratan pendaftaran sebagai berikut:<br>
                        1. Mengisi formulir pendaftaran<br>
                        2. Dinyatakan lulus ujian seleksi
                        (Pengetahuan umum, keagamaan dan baca tulis Al Qur’an)<br>
                        3. Bersedia tinggal di asrama dan menghafal Al Qur’an<br>
                        4. Bersedia mentaati peraturan SMP Tahfidz Al Hikmah<br>
                        5. (4) lembar Pas Foto Berwarna terbaru ukuran 3x4<br>
                        6. (1) lembar Fotokopi Akta Kelahiran<br>
                        7. (1) lembar Fotokopi Kartu Keluarga<br>
                        8. (1) lembar Fotokopi NISN<br>
                        9. (1) lembar Fotokopi Nilai Rapor Kelas VI<br>
                        10. (1) lembar Fotokopi Kartu Indonesia Pintar (Jika Memiliki)<br>
                        11. Membayar biaya administrasi
                      </p>
                      <p>
                        Unduh file berikut untuk informasi lebih lengkap
                        <a href="pendaftaran.pdf" download><b>Download</b></a>
                      </p>
                    </div>
                  </div>
                </div>
